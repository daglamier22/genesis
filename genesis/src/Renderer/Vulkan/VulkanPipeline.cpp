...
namespace Genesis {
    bool VulkanPipeline::createGraphicsPipeline(VulkanDevice device, VulkanSwapchain swapchain) {
        ...
        if (vkCreatePipelineLayout(device.getDevice(), &pipelineLayoutInfo, nullptr, &m_vkPipelineLayout) != VK_SUCCESS) {
        ...
        if (vkCreateGraphicsPipelines(device.getDevice(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &m_vkGraphicsPipeline) != VK_SUCCESS) {
    ...
    bool VulkanPipeline::createRenderPass(VulkanDevice device, VulkanSwapchain swapchain) {
